...
export const baseSchema = z.object({
  ...
  // Phase 7 (nutrition & calories). Daily hydration goal (mL).
  HYDRATION_GOAL_ML: intFromString('HYDRATION_GOAL_ML').default(3000),
  // Rolling window (days) for nutrition trends.
  NUTRITION_TREND_DAYS: intFromString('NUTRITION_TREND_DAYS').default(30),
